    ...
    public static class ItemStringHelper
    {
        ...
        public static string GetGearPropString(GearPropType propType, long value, int signFlag, bool isMsea = false)
        {
            ...
            switch (propType)
            {
                ...
                case GearPropType.reissueBan: return value == 0 ? null : "Cannot be re-issued";
        ...
        public static List<string> GetExtraJobReqStringList(IEnumerable<int> specJobs, bool isMsnMode = false, bool isMsea = false)
        {
            ...
            if (isMsnMode)
            {
                ...
                {
                    extraJobNames.Add("Cygnus Knight class");
                }
                else
                {
                    int classBranch = 0;
        ...
        public static string GetJobName(int jobCode, bool isMsea = false)
        {
            switch (jobCode)
            {
                ...
                case 213: return "Arch Mage (F/P)(5)";
                case 214: return "Arch Mage (F/P)(6)";
                case 220: return "Wizard (I/L)";
                case 221: return "Mage (I/L)";
                case 222: return "Arch Mage (I/L)";
                case 223: return "Arch Mage (I/L)(5)";
                case 224: return "Arch Mage (I/L)(6)";
