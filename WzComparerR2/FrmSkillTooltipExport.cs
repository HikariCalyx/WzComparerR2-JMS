...
namespace WzComparerR2
{
    ...
    {
        public FrmSkillTooltipExport(bool isDarkMode, bool isMsea = false)
        {
            InitializeComponent();
            if (isDarkMode)
            {
        ...
        private static Dictionary<string, int[]> jobNameToCodeGms = new Dictionary<string, int[]>()
        {
            ...
            { "Lethe", new int[] { 19000, 19200, 19210, 19211, 19212, 19214 } },
        ...
        private void btnExport_Click(object sender, EventArgs e)
        {
            ...
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                ...
                if (this.clbJobName.CheckedItems.Contains("Roguelike Skill (Pharaoh's Treasure)"))
                {
