...
namespace WzComparerR2
{
    public partial class FrmCustomCSS : DevComponents.DotNetBar.Office2007Form
    {
        ...
        private void colorPickers_SelectedColorChanged(object sender, EventArgs e)
        {
            ...
            var contents = new[]
            {
                new {Text = "                一般的なコンテンツ               " + Environment.NewLine, Fore = normalTextColor, Back = backgroundColor},
                new {Text = "               変更されたコンテンツ               " + Environment.NewLine, Fore = changedTextColor, Back = changedBackgroundColor},
                new {Text = "               追加されたコンテンツ               " + Environment.NewLine, Fore = addedTextColor, Back = addedBackgroundColor},
                new {Text = "               削除されたコンテンツ               ", Fore = removedTextColor, Back = removedBackgroundColor}
            };
