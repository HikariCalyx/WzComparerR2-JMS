...
namespace WzComparerR2
{
    public partial class FrmCustomCSS : DevComponents.DotNetBar.Office2007Form
    {
        ...
        private void colorPickers_SelectedColorChanged(object sender, EventArgs e)
        {
            ...
            var contents = new[]
            {
                new {Text = "ハイパーリンク" + Environment.NewLine, Fore = hyperlinkColor, Back = backgroundColor, Underline = true},
                new {Text = "                一般的なコンテンツ               " + Environment.NewLine, Fore = normalTextColor, Back = backgroundColor, Underline = false},
                new {Text = "               変更されたコンテンツ               " + Environment.NewLine, Fore = changedTextColor, Back = changedBackgroundColor, Underline = false},
                new {Text = "               追加されたコンテンツ               " + Environment.NewLine, Fore = addedTextColor, Back = addedBackgroundColor, Underline = false},
                new {Text = "               削除されたコンテンツ               ", Fore = removedTextColor, Back = removedBackgroundColor, Underline = false}
            };
