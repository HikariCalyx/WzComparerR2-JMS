    ...
    public class MapTooltipRenderer : TooltipRender
    {
        ...
        public override Bitmap Render()
        {
            ...
            if (Map.MapID > -1)
            {
                ...
                var block = PrepareText(g, mapName[0], Translator.IsKoreanStringPresent(mapName[0]) ? GearGraphics.KMSItemDetailFont : GearGraphics.ItemDetailFont, Enable22AniStyle ? (Brush)new SolidBrush(Color.FromArgb(-2825755)) : Brushes.White, 0, picY);
                titleBlocks.Add(block);
                int tw = block.Size.Width;

                block = PrepareText(g, mapName[1], Translator.IsKoreanStringPresent(mapName[0]) ? GearGraphics.KMSItemDetailFont : GearGraphics.ItemDetailFont, Brushes.White, 0, picY += 18);
                titleBlocks.Add(block);
