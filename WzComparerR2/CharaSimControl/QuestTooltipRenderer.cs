...
namespace WzComparerR2.CharaSimControl
{
    public class QuestTooltipRenderer : TooltipRender
    {
        ...
        private Bitmap RenderBase()
        {
            ...
            TextRenderer.DrawText(g2, $"状態: {stateText[state]}" + (this.Quest.Blocked ? " / クエスト開始不可" : ""), GearGraphics.EquipMDMoris9Font, new Point(21, bg.Height - 26), ((SolidBrush)GearGraphics.QuestBrushEnd).Color, TextFormatFlags.NoPadding);
