...
/*                    var match = Regex.Match(typeName, @"^(\(.*\)|（.*）|\[.*\])$");
                ...
                if (isSilverWolf)
                {
                    ...
                    TextRenderer.DrawText(g, Compact(g, "銀狼武器のうち1つ", 200), GearGraphics.EquipMDMoris9Font, new Point(90, picHeight), ((SolidBrush)GearGraphics.Equip22BrushDarkGray).Color, TextFormatFlags.NoPadding);
                    picHeight += 15;
                }
            }
            else
