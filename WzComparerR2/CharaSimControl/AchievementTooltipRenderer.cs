...
namespace WzComparerR2.CharaSimControl
{
    public class AchievementTooltipRenderer : TooltipRender
    {
        ...
        public override Bitmap Render()
        {
            ...
            {
                g.DrawImage(checkIncomplete, 16, picH);
                GearGraphics.DrawString(g, Compact(g, $"先行業績: {string.Join(", ", this.Achievement.PriorIDs.Select(id =>
                {
            ...
            {
                g.DrawImage(checkIncomplete, 16, picH);
                GearGraphics.DrawString(g, "業績ウィンドウに表示されない", GearGraphics.EquipMDMoris9Font, null, 32, 550, ref picH, bg_pattern.Height, defaultColor: GearGraphics.GrayColor2);
            }
