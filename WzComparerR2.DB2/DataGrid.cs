...
namespace WzComparerR2.DB2
{
    class DataViewer : DataGridView
    {
        ...
        public DataViewer(GridType gridType)
        {
            ...
            DefaultCellStyle.Font = new System.Drawing.Font("メイリオ", 11);
            ...
            FamiliarSkillName.HeaderText = "スキル";
            ...
            FamiliarSkillDesc.HeaderText = "スキル説明";
            ...
            FamiliarCardID.HeaderText = "ファミリアカードID";
