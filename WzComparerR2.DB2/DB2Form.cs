    ...
    public partial class DB2Form : DevComponents.DotNetBar.Office2007Form
    {
        ...
        string ToData(Wz_Node E)
        {
            ...
            switch (E.Text)
            {
                case "tradeAvailable":
                    if (E.ValueToInt() == 1)
                        return "Scissors of Karma (normal)";
                    else if (E.ValueToInt() == 2)
                        return "Scissors of Karma (platinum)";
                    else break;
                    ...
                    else
                    {
                        ...
                        for (int i = 0; i < bits.Length; i++)
                        {
                            if (bits[i] == '1')
                            {
                                switch (i)
                                {
                                    case 0: returnList.Add("Warrior"); break;
                                    case 1: returnList.Add("Magician"); break;
                                    case 2: returnList.Add("Bowman"); break;
                                    case 3: returnList.Add("Thief"); break;
                                    case 4: returnList.Add("Pirate"); break;
                                }
                            }
                        }
                ...
                case "addition":
                    if (E.HasNode("mobcategory"))
                        ...
                        return "Defeat Effect";
                    else if (E.HasNode("statinc"))
                        return "Additional Ability";
                    else break;
                case "variableStat":
                    if (E.HasNode("incPAD"))
                        return "Attack Power Increase Rate: " + E.GetNode("incPAD").Value.ToString();
                    else break;
                case "incRMAI":
                case "incRMAL":
                case "incRMAF":
        ...
        void LoadCharacter()
        {
            ...
            ToName.Add("price", "Sale Price: ");
            ToName.Add("reqLevel", "REQ LEV: ");
            ToName.Add("reqJob", "Applicable Job: ");
            ...
            ToName.Add("reqPOP", "Popularity Required: ");
            ToName.Add("attackSpeed", "Speed: ");
            ...
            ToName.Add("incPAD", "Attack Power+");
            ToName.Add("incMAD", "Magic Power+");
            ToName.Add("incPDD", "Defense+");
            ToName.Add("incMDD", "Magic Defense+");
            ToName.Add("incACC", "Accuracy+");
            ToName.Add("incEVA", "Evasion+");
            ToName.Add("incSpeed", "Move Speed+");
            ToName.Add("incJump", "Jump+");
            ToName.Add("incCraft", "Diligence+");
            ToName.Add("craftEXP", "Diligence EXP+");

            ToName.Add("incPVPDamage", "PVP Damage Increase+");
            ToName.Add("bdR", "Boss Monster Attack Damage+");
            ToName.Add("imdR", "Ignore Monster Defense+");
            ToName.Add("willEXP", "Will EXP+");
            ToName.Add("charmEXP", "Charm EXP+");
            ToName.Add("charismaEXP", "Leadership EXP+");
            ToName.Add("knockback", "Knockback Chance on Direct Hit:");
            ToName.Add("reduceReq", "Required Level Decrease:");

            ToName.Add("incRMAI", "Ice Magic+");
            ToName.Add("incRMAL", "Lightning Magic+");
            ToName.Add("incRMAF", "Fire Magic+");
            ToName.Add("incRMAS", "Poison Magic+");
            ToName.Add("durability", "Durability: ");
            ToName.Add("tuc", "Upgrades Available: ");

            ToName.Add("level", "");
            ToName.Add("head", "");
            ToName.Add("option", "");
            ToName.Add("addition", "");
            ToNameBool.Add("expireOnLogout", "Disappears on Logout");
            ToNameBool.Add("tradeBlock", "Untradeable");
            ToNameBool.Add("notSale", "Cannot be Sold");
            ToNameBool.Add("only", "Unique Item");
            ToNameBool.Add("equipTradeBlock", "Untradeable Once Equipped");
            ToNameBool.Add("epicItem", "Legendary");
            ToNameBool.Add("timeLimited", "Time-limited Item");
            ToNameBool.Add("noExtend", "Cannot Extend Validity Period");
            ToNameBool.Add("notExtend", "Cannot Extend Validity Period");
            ToNameBool.Add("quest", "Quest Item");
            ToNameBool.Add("accountSharable", "Transferable Only Between Characters in the Same World");
            ToNameBool.Add("exItem", "Set Equipment");
            ...
            ToName.Add("mobcategory", "Monster Bonus");
            ToName.Add("boss", "Boss Bonus");
            ToName.Add("skill", "Attack Effect");
            ToName.Add("critical", "Critical");
            ToName.Add("mobdie", "Defeat Effect");
            ToName.Add("statinc", "Additional Ability");
        ...
        void LoadMob(int Part)
        {
            ...
            Category.Add("1", "Mammal Type");
            Category.Add("2", "Plant Type");
            Category.Add("3", "Fish Type");
            Category.Add("4", "Reptile Type");
            Category.Add("5", "Spirit Type");
            Category.Add("6", "Devil Type");
            Category.Add("7", "Undead Type");
            Category.Add("8", "Formless");

            ToName.Add("level", "Level:");
            ToName.Add("exp", "EXP:");
            ToName.Add("maxMP", "MP:");
            ToName.Add("maxHP", "HP:");
            ToName.Add("speed", "Speed:");
            ToName.Add("acc", "Accuracy:");
            ToName.Add("pushed", "Knockback:");
            ToName.Add("category", "Category:");
            ToName.Add("eva", "Evasion:");
            ToName.Add("link", "Link:");
            ToName.Add("elemAttr", "Element:");
            ToName.Add("MADamage", "Magic Damage:");
            ToName.Add("MDDamage", "Magic Defense:");
            ToName.Add("PADamage", "Physical Damage:");
            ToName.Add("PDDamage", "Physical Defense:");
            ToName.Add("PDRate", "Physical Defense Rate:");
            ToName.Add("MDRate", "Magic Defense Rate:");
            ToName.Add("boss", "Boss");
            ToName.Add("firstAttack", "First Strike");
            ToName.Add("charismaEXP", "Charisma:");
            ToName.Add("hpRecovery", "HP Recovery:");
            ToName.Add("mpRecovery", "MP Recovery:");
        ...
        void LoadFamiliar()
        {
            ...
            {
                MessageBoxEx.Show(this, "Familiar not found");
                return;
            }
            Wz_Node CardEntry;
        ...
        private void LoadButton_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBoxEx.Show(this, "Base.wz has not been opened");
                return;
            }
        ...
        private void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            MessageBoxEx.Show(this, Grid.Parent.Name + ".BIN save completed");
        }
        ...
        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            var font = new System.Drawing.Font("Segoe UI", ParseOr(comboBox2.Text, DefaultCellFontSize));
        ...
        void ApplyGridStyle(DataViewer grid)
        {
            ...
            grid.DefaultCellStyle.Font = new System.Drawing.Font("Segoe UI", ParseOr(comboBox2.Text, DefaultCellFontSize));
        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            this.FormClosing += (s, e1) =>
           {
            ...
            comboBox1.Font = new Font("Segoe UI", (float)Size10);
            comboBox2.Font = new Font("Segoe UI", (float)Size10);
            comboBox3.Font = new Font("Segoe UI", (float)Size10);
            comboBox4.Font = new Font("Segoe UI", (float)Size12);

            label2.Font = new Font("Segoe UI", (float)Size12);
            label3.Font = new Font("Segoe UI", (float)Size12);
            label4.Font = new Font("Segoe UI", (float)Size12);
            label6.Font = new Font("Segoe UI", (float)Size12);

            gridsReady = true;
            ApplyTheme();

            SearchBox.Font = new Font("Segoe UI", (float)Size11);
            LoadButton.Font = new Font("Segoe UI", (float)Size12);
            SaveButton.Font = new Font("Segoe UI", (float)Size12);
            tabControl1.TabFont = new Font("Segoe UI", (float)Size13);
            tabControl1.SelectedTabFont = new Font("Segoe UI", (float)Size13, FontStyle.Bold);
